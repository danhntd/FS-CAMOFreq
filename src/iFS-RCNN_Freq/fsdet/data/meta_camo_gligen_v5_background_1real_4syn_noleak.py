...
__all__ = ["register_meta_camo_gligen_v5_background_1real_4syn_noleak"]
...
def load_camo_json(json_file, image_root, metadata, dataset_name, sid):
    ...
    if is_shots:
        ...
        split_dir = os.path.join("datasets", "camo/Annotations/gligen/camosplit_gligen_v5_background_1real_4syn_noleak/subsplit", 'split{}'.format(sid))
...
def register_meta_camo_gligen_v5_background_1real_4syn_noleak(name, metadata, imgdir, annofile, sid):
