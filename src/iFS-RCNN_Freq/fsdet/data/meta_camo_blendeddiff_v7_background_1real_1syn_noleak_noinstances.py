...
__all__ = ["register_meta_camo_blendeddiff_v7_background_1real_1syn_noleak_noinstances"]
...
def load_camo_json(json_file, image_root, metadata, dataset_name, sid):
    ...
    if is_shots:
        ...
        split_dir = os.path.join("datasets", "camo/Annotations/blendeddiff/camosplit_blendeddiff_v7_background_1real_1syn_noleak_noinstances/subsplit", 'split{}'.format(sid))
...
def register_meta_camo_blendeddiff_v7_background_1real_1syn_noleak_noinstances(name, metadata, imgdir, annofile, sid):
    ...
    MetadataCatalog.get(name).set(
        ...
        image_root=imgdir,
        evaluator_type="camo",
        dirname="datasets/camo/images_bg_syn_noinstances",
        **metadata,
    )
