...
__all__ = ["register_meta_camo_blendeddiff_v2_histogrammatching"]
...
def load_camo_json(json_file, image_root, metadata, dataset_name, sid):
    ...
    if is_shots:
        ...
        split_dir = os.path.join("datasets", "camo/Annotations/blendeddiff/camosplit_blendeddiff_v0/subsplit", 'split{}'.format(sid))
...
def register_meta_camo_blendeddiff_v2_histogrammatching(name, metadata, imgdir, annofile, sid):
