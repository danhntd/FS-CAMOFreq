...
__all__ = ["register_meta_camo_diffinpainting_v3_histogrammatching_1real_4syn"]
...
def load_camo_json(json_file, image_root, metadata, dataset_name, sid):
    ...
    if is_shots:
        ...
        split_dir = os.path.join("datasets", "camo/Annotations/diffinpainting/camosplit_diffinpainting_v3_1real_4syn/subsplit", 'split{}'.format(sid))
...
def register_meta_camo_diffinpainting_v3_histogrammatching_1real_4syn(name, metadata, imgdir, annofile, sid):
