...
__all__ = ["register_meta_camo_gligen_v1_histogramfiltering"]
...
def load_camo_json(json_file, image_root, metadata, dataset_name, sid):
    ...
    if is_shots:
        ...
        split_dir = os.path.join("datasets", "camo/Annotations/gligen/camosplit_gligen_v1_histogramfiltering/subsplit", 'split{}'.format(sid))
...
def register_meta_camo_gligen_v1_histogramfiltering(name, metadata, imgdir, annofile, sid):
