...
__all__ = ["register_meta_camo_datazoo_v5_histogrammatching_1real_4syn_noleak"]
...
def load_camo_json(json_file, image_root, metadata, dataset_name, sid):
    ...
    if is_shots:
        ...
        split_dir = os.path.join("datasets", "camo/Annotations/datazoo/camosplit_datazoo_v5_1real_4syn_noleak/subsplit", 'split{}'.format(sid))
...
def register_meta_camo_datazoo_v5_histogrammatching_1real_4syn_noleak(name, metadata, imgdir, annofile, sid):
