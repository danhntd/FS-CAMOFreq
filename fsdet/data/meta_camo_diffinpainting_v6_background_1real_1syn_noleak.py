...
__all__ = ["register_meta_camo_diffinpainting_v6_background_1real_1syn_noleak"]
...
def load_camo_json(json_file, image_root, metadata, dataset_name, sid):
    ...
    if is_shots:
        ...
        split_dir = os.path.join("datasets", "camo/Annotations/diffinpainting/camosplit_diffinpainting_v6_background_1real_1syn_noleak/subsplit", 'split{}'.format(sid))
...
def register_meta_camo_diffinpainting_v6_background_1real_1syn_noleak(name, metadata, imgdir, annofile, sid):
    ...
    MetadataCatalog.get(name).set(
        ...
        image_root=imgdir,
        evaluator_type="camo",
        dirname="datasets/camo/images_bg_syn",
        **metadata,
    )
